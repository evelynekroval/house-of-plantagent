...
if not st.session_state.messages:
    system_message = """You are an expert vegan/plant-based nutritionist and meal generator.
...
- If the user asks non-recipe related questions, state that your purpose is only to generate user recipes."""  # type:ignore
